...
async def main():
    ...
    # Start all units
    units = [keyboard_listener, sound_recorder, noise_cancelling, voice_recognition, 
             output_handler, shared_state, tray_control]
    ...
    await asyncio.gather(bridge_task, tray_simulator_task, *tasks, return_exceptions=True)
